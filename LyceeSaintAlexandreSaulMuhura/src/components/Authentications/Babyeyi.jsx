...
//           <h2 className="text-base md:text-lg font-semibold mb-3 md:mb-4">Current Information</h2>
...
const BabyeyiLetter = () => {
    ...
    return (
        <div>
            ...
            {/* Staff Form */}
            <div className="bg-white rounded-lg shadow p-3 md:p-6">
                <h2 className="text-base md:text-lg font-semibold mb-3 md:mb-4 text-black">Babyeyi Letter</h2>
