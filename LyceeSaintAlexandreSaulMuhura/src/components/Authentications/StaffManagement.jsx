                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-xs md:text-sm">
                            <thead className="bg-gray-50">
                                <tr>
                                    <th className="p-2 md:p-4 text-left text-black">#</th>
                                    <th className="p-2 md:p-4 text-left text-black">Full Names</th>
                                    <th className="p-2 md:p-4 text-left text-black">Phone Number</th>
                                    <th className="p-2 md:p-4 text-left text-black">Email Address</th>
                                    <th className="p-2 md:p-4 text-left text-black">Position</th>
                                    <th className="p-2 md:p-4 text-left text-black">Teacher Option</th>
                            ...
                            <tbody>
                                {staffData.map((staff) => (
                                    <tr key={staff.id}>
                                        <td className="p-2 md:p-4">{staff.id}</td>
